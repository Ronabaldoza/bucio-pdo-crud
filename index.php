...
<head>
    ...
    <style>
        body {
            background: url(https://image.slidesdocs.com/responsive-images/background/coffee-brown-leaves-illustration-powerpoint-background_057b86ae1e__960_540.jpg);
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="#">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTuQH2sxchgJ0MPn-YOeL9rC8c1wFXCx-r9rw&s" width="30" height="30" class="d-inline-block align-top" alt="Softball Logo">
            <span style="color: white;">Rona coffee Store</span>
        </a>
